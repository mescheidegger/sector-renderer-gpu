...
test('texture registry rejects bad keys and conflicting shared upload images', () => {
  ...
  const uploadGl = { ...gl, TEXTURE_2D:1, RGBA:2, UNSIGNED_BYTE:3, UNPACK_FLIP_Y_WEBGL:4, TEXTURE_WRAP_S:5, TEXTURE_WRAP_T:6, CLAMP_TO_EDGE:7, REPEAT:8, TEXTURE_MAG_FILTER:9, TEXTURE_MIN_FILTER:10, NEAREST:11, LINEAR:12, LINEAR_MIPMAP_LINEAR:13, MAX_TEXTURE_SIZE:14, getParameter: () => 4096, createTexture: () => ({}), bindTexture(){}, pixelStorei(){}, texImage2D(){}, texParameteri(){}, generateMipmap(){} };
